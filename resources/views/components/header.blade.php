    ...
    <div class="main-container page-header__container">
        ...
        <div class="header__nav">
            <ul class="header-nav__list site-list">
                <li class="site-list__item @if (Route::currentRouteName() === 'browse.page') {{ 'site-list__item--active' }} @endif">
                    <a href="{{ route('browse.page') }}">Задания</a>
                </li>
                <li class="site-list__item @if (Route::currentRouteName() === 'users.page') {{ 'site-list__item--active' }} @endif">
                    <a href="{{ route('users.page') }}">Исполнители</a>
                </li>
                @auth
                    <li class="site-list__item @if (Route::currentRouteName() === 'task-create.page') {{ 'site-list__item--active' }} @endif">
                        <a href="{{ route('task-create.page') }}">Создать задание</a>
                    </li>
                    <li class="site-list__item @if (Route::currentRouteName() === 'user.page') {{ 'site-list__item--active' }} @endif">
                        <a href="{{ route('user.page', ['id' => auth()->id()]) }}">Мой профиль</a>
                    </li>
                @endauth
            </ul>
        </div>
        ...
        <div class="account__pop-up">
            <ul class="account__pop-up-list">
                <li>
                    <a href="{{ route('mylist.page') }}">Мои задания</a>
                </li>
                <li>
                    <a href="{{ route('account.page') }}">Настройки</a>
                </li>
                <li>
                    <a href="{{ route('logout.perform') }}">Выход</a>
                </li>
            </ul>
        </div>
    </div>
