    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                <li class="menu-toggle__item @if(!count(request()->all())) {{ 'menu_toggle__item--current' }} @endif menu-toggle__item--completed">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="21px" height="21px" viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" enable-background="new 0 0 52 52" xml:space="preserve">
                ...
                <li class="menu-toggle__item @if(request()->has('completed')) {{ 'menu_toggle__item--current' }} @endif menu-toggle__item--completed">
                    <div class="menu-toggle__svg-wrapper">
                ...
                <li class="menu-toggle__item @if(request()->has('active')) {{ 'menu_toggle__item--current' }} @endif menu-toggle__item--active">
                    <div class="menu-toggle__svg-wrapper">
                ...
                <li class="menu-toggle__item @if(request()->has('cancelled')) {{ 'menu_toggle__item--current' }} @endif menu-toggle__item--canceled">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="menu-toggle__item @if(request()->has('expired')) {{ 'menu_toggle__item--current' }} @endif menu-toggle__item--hidden">
                    <div class="menu-toggle__svg-wrapper">
                ...
                <li class="menu-toggle__item @if(request()->has('performing')) {{ 'menu_toggle__item--current' }} @endif menu-toggle__item--new">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @if($task->performer)
                            <div class="feedback-card__top">
                                ...
                                <div class="feedback-card__top--name my-list__bottom">
                                    <p class="link-name">
                                        <a href="{{ route('user.page', ['id' => $task->performer->id]) }}" class="link-regular">{{ $task->performer->name }}</a>
                                    </p>
                                    <a href="{{ route('task.page', ['id' => $task->id]) }}" class="my-list__bottom-chat @if($task->messages->whereNull('read_at')->count() > 0) {{ 'my-list__bottom-chat--new' }} @endif">
                                        @if($task->messages->whereNull('read_at')->count() > 0)
                                            <b>{{ $task->messages->whereNull('read_at')->count() }}</b>
                                        @endif
                                    </a>
                                    <x-user-rating :rating="$task->performer->rating"></x-user-rating>
