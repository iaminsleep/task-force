        ...
        <section class="create__task">
            ...
            <div class="create__task-main">
                <form class="create__task-form form-create" method="post" action="{{ route('task-create.perform') }}"
                    ...
                    <input class="input textarea" rows="1" id="10" name="title" placeholder="Повесить полку" />

                    <span>Кратко опишите суть работы</span>
                    <label for="11">Подробности задания</label>
                    <input class="input textarea" rows="7" id="11" name="description" placeholder="Срочная работа" />
